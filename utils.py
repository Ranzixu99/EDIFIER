...
def ConvertInput(pdb_path : str , label : int) :
    ...
    nodes , edges =  pickle.load(open(f"./total_feature/{os.path.basename(pdb_path)[:-4]}.pkl","rb"))
    # nodes , edges =  pickle.load(open(f"./feature_without_bert/{os.path.basename(pdb_path)[:-4]}.pkl","rb"))
